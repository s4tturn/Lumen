...
- **Home Screen** - Async-rendered canvas dot matrix (`HomeView`) with concentric rings, continuous time-based wave ripple, spring-based long-press scale reaction (up to 1.5×) with delayed onset and velocity-preserving release, and RadialGradient edge fading.
